...
devcall ttycontrol(struct dentry *, int32, int32, int32); /* in file ttycontrol.c */
devcall ttygetc(struct dentry *); /* in file ttygetc.c */
void    ttyhandler(uint32); /* in file ttyhandler.c */
devcall	ttyinit(struct dentry *); /* in file ttyinit.c */
devcall	ttyputc(struct dentry *, char); /* in file ttyputc.c */
devcall	ttyread(struct dentry *, char *, int32); /* in file ttyread.c */
devcall	ttywrite(struct dentry *, char *, int32); /* in file ttywrite.c */
